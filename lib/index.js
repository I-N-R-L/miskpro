...
const { quoted, hentaivideo, send_vote } = require('./database/semifunction/send_m_t_q');
module.exports = {
    ...
    dogphoto, lovephoto, cartoonphoto, googleIt, wikiMedia, ringTone, quoted, hentaivideo, send_vote
}
