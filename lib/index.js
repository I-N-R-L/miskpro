...
const { remove, unscreen, sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu, sendRepeat } = require('./database/semifunction/send_buffer_data');
...
module.exports = {
    ...
    serif_B,
    serif_BI,
    serif_I, remove, unscreen, sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu, sendRepeat, getYtV, getYtA, ytmp4, ytmp3, weather, movie,
