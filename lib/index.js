...
const { getYtV, getYtA, ytmp4 } = require('./youtube');
...
module.exports = {
    ...
    serif_B,
    serif_BI,
    serif_I, remove, unscreen, sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu, getYtV, getYtA, ytmp4,
