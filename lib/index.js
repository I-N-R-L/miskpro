...
const { googleIt, wikiMedia, ringtone, mediaFire, gitClone, happyMod } = require('./database/semifunction/serch_query');
module.exports = {
    ...
    dogphoto, lovephoto, cartoonphoto,
    googleIt, wikiMedia, ringtone, mediaFire, gitClone, happyMod
}
