...
const { getYtV, getYtA, ytmp4, ytmp3 } = require('./youtube');
...
const { remove, unscreen, sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu } = require('./database/semifunction/send_buffer_data');
...
module.exports = {
    ...
    serif_B,
    serif_BI,
    serif_I, remove, unscreen, sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu, getYtV, getYtA, ytmp4, ytmp3,
    ...
    dogphoto, lovephoto, cartoonphoto, googleIt, wikiMedia, ringTone, quoted, hentaivideo, send_vote, send_poll, truecaller, stickersearch
}
