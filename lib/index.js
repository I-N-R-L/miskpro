...
const { sendUrl, tinyUrl, webSs, pdfGen, BufferToFile, AudioMetaData, send_alive, send_menu } = require('./database/semifunction/send_buffer_data');
...
const { quoted, hentaivideo, send_vote, send_poll, truecaller } = require('./database/semifunction/send_m_t_q');
module.exports = {
