...
const { letiableDb,CreateDb,Update letiable,get let} = require("./database/ letiable");
...
return c
  ...
  ut_sec = ut_sec%60; 
   ...
   let uptime_process = (`Runtime: ${ut_hour} Hour  ${ut_min} minute ${ut_sec} second`)  
},
...
letiableDb,CreateDb,Update letiable,get let,
