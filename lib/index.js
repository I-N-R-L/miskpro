...
const { sendUrl, tinyUrl, webSs, pdfGen, urlBufferToImgFile, AudioMetaData  } = require('./database/url');
module.exports = {
    ...
    serif_B,
    serif_BI,
    serif_I, sendUrl, tinyUrl, webSs, pdfGen, urlBufferToImgFile, AudioMetaData 
}
