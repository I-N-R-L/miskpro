...
let urvideo = await client.downloadAndSaveMediaMessage(message.quoted.videoMessage)
imgur.setClientId(clientId)
imgur
  .uploadFile(urvideo)
  .then((json) => {
    await client.sendMessage( message.from, {text : "url=>"+json.link }, { quoted: message })
        })
