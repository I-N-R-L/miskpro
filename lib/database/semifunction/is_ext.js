...
const document = {key : {participant : '0@s.whatsapp.net', ...(m.key.remoteJid ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title:Config.MENSION.MENSION_TEXT.split(',')[0],jpegThumbnail: getBuffer(Config.BOT_INFO.split(',')[2])}}}
...
const gift = {key: {participant: `0@s.whatsapp.net`, ...(m.key.remoteJid ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":Config.BOT_INFO.split(',')[0], "h": Config.MENSION.MENSION_TEXT.split(',')[0],'seconds': '359996400', 'gifPlayback': 'true', 'caption':Config.BOT_INFO.split(',')[0], 'jpegThumbnail': getBuffer(Config.BOT_INFO.split(',')[2])}}}
...
const video = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.key.remoteJid? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":Config.BOT_INFO.split(',')[0], "h": Config.BOT_INFO.split(',')[1],'seconds': '359996400', 'caption': `${m.client.pushname}`, 'jpegThumbnail': getBuffer(Config.BOT_INFO.split(',')[2])}}}
const local = {key : {participant : '0@s.whatsapp.net', ...(m.key.remoteJid ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: Config.BOT_INFO.split(',')[0],jpegThumbnail: getBuffer(Config.BOT_INFO.split(',')[2])}}}
const contact = { key: {participant: `0@s.whatsapp.net`, ...(m.key.remoteJid ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName':Config.BOT_INFO.split(',')[0], 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${Config.BOT_INFO.split(',')[1]},;;;\nFN:${Config.BOT_INFO.split(',')[1]}\nitem1.TEL;waid=${Config.OWNER}:${Config.OWNER}\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': getBuffer(Config.BOT_INFO.split(',')[2]), thumbnail: getBuffer(Config.BOT_INFO.split(',')[2]),sendEphemeral: true}}}
const status = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.key.remoteJid ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": Config.MENSION.MENSION_TEXT.split(',')[1] ,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail":getBuffer(Config.BOT_INFO.split(',')[2]),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
"pollCreationMessage": {
"name": t0 || Config.BOT_INFO.split(',')[2] || t,
"options":options,
