...
const msUrl = Config.MENSION.MENSION_TEXT.split(',')[2];
        ...
        conn.sendMessage(m.from, {audio : fs.readFileSync('./media/mension/mension/mp3.mp3'), mimetype: 'audio/mpeg', ptt: true,waveform: [10,50,100,50,10,50,100,50,10,50,100,50,10],contextInfo: { externalAdReply:{
        title:"ZIM BOT V4",
        body:"SUB DRIPS OFC",
