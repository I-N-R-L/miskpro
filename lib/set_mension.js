...
const msUrl = Config.MENSION.MENSION_TEXT.split(',')[2];
        conn.sendMessage(m.from, { audio : audio , mimetype: 'audio/mpeg', ptt: true,m, waveform: [10,10,30,50,70,90,100,100,90,70,50,30,10,10], contextInfo: { externalAdReply:{
        title : Config.MENSION.MENSION_TEXT.split(',')[0],
        body : Config.MENSION.MENSION_TEXT.split(',')[1],
        showAdAttribution: true,
        mediaType : 2,
        thumbnail : imag,
        mediaUrl: "https://www.instagram.com/"+msUrl, 
