...
if(fake.includes(' ')){
let Isnext = fake.replaceAll(" ","");
let IsNext = (Isnext.toLowerCase());
}else {
IsNext = (fake.toLowerCase());
}
...
if(Istext.includes(' ')){
let Isnext = Istext.replaceAll(" ","");
let IsNext = (Isnext.toLowerCase());
} else {
let isSplit = (fake.toLowerCase());
}
var isJid = isSplit
if(isJid.match(m.from)){;
let isText = (m.client.displayText.toLowerCase());
...
if(FakeNum.includes(' ')){
let Isnext = FakeNum.replaceAll(" ","");
let IsFake = (Isnext.toLowerCase());
}else {
let IsFake = (fake.toLowerCase());
}
...
let Isnext = BadWords.replaceAll(" ","");
let ThenBad = (Isnext.toLowerCase());
}else {
let ThenBad = (fake.toLowerCase());
}
