...
var IsNext = (fake.toLowerCase());
if(fake.includes(' ')){ Isnext = fake.replaceAll(" ","");IsNext = (Isnext.toLowerCase()); }
...
if(m.isGroup && m.client.isCreator){
let Istext = Config.ALL_LINK_BAN;
var isSplit = (Istext.toLowerCase());
if(Istext.includes(' ')){ Isnext = Istext.replaceAll(" ","");isSplit = (Istext.toLowerCase()); }
var isJid = isSplit
if(isJid.match(m.from)){;
let isText = (m.client.displayText.toLowerCase());
...
var IsFake = (FakeNum.toLowerCase());
if(FakeNum.includes(' ')){ Isnext = FakeNum.replaceAll(" ","");IsFake = (Isnext.toLowerCase()); }
...
var ThenBad = (BadWords.toLowerCase());
if(BadWords.includes(' ')){ Isnext = BadWords.replaceAll(" ","");ThenBad = (Isnext.toLowerCase()); }
