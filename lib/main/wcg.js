...
class WCG {
        ...
        async start() {
                ...
                if (this.word != "start" && !await this.isGame() && this.m.client.body.toLowerCase().includes('wcg')) return await this.m.send("_wcg *start* to start this game_");
...
*· total players: ${remains+'/'+total}*`,
                        ...
                        return await this.m.send(new Error(`rejected overstressed text array`));
                }
        }
        async isGame() {
