...
class serialize {
    ...
    _message(conn) {
        if (this.message) {
            ...
            this.quoted = this.msg?.contextInfo ? this.msg?.contextInfo?.quotedMessage : false
                this.quoted.type = this.reply_message.type = this.quoted?getContentType(this.quoted) :false;
                this.quoted.msg = this.quoted?this.quoted[this.quoted?.type]:false;
                this.quoted.mentions = this.msg?.contextInfo?.mentionedJid||false
                this.quoted.id = this.reply_message.key = this.msg?.contextInfo?.stanzaId||false;
                this.quoted.sender = jidNormalizedUser(this.msg?.contextInfo?.participant || this.sender)||false
                ...
                this.quoted.text = this.reply_message.text = (this.quoted?.msg?.caption ? this.quoted?.msg?.caption : this.quoted?.msg)||false;
    ...
    _client(conn, createrS) {
        this.sock = conn;
        this.client = conn;
        this.client.displayText = this.message?.conversation || this.message?.[this.type]?.text || this.message?.[this.type]?.caption || this.message?.[this.type]?.contentText || this.message?.[this.type]?.selectedDisplayText || this.message?.[this.type]?.title ||false;
        this.client.displayId = this.client.body = this.message?.conversation || this.message?.[this.type]?.text || this.message?.[this.type]?.caption || this.message?.[this.type]?.selectedButtonId || this.message?.[this.type]?.singleSelectReply?.selectedRowId || this.message?.[this.type]?.selectedId || this.type === "messageContextInfo" ? this.message.buttonsResponseMessage?.selectedButtonId || this.message.listResponseMessage?.singleSelectReply?.selectedRowId || this.text : false;
        this.client.budy = typeof this.text == "string" ? this.text : false;
