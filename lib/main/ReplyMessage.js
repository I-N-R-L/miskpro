    ...
    _message(conn) {
        if (this.message) {
            ...
            if(this.quoted&&this.reply_message){
                ...
                this.quoted.mentions = this.reply_message.mentions = this.msg?.contextInfo?.mentionedJid;
                ...
                this.quoted.text  = this.reply_message.text = this.quoted?.text || this.quoted?.msg?.caption || this.quoted?.conversation || "";
                ...
                this.quoted.fakeObj = this.reply_message.fakeObj = M.fromObject({
                    key: {
         ...
         if(options.linkPreview) {
                V3mmfFrd = {
                    externalAdReply: {
                        ...
                        mediaType: options.linkPreview.mediaType || 2,
                        thumbnailUrl:options.linkPreview.thumbnailUrl,
                        previewType:options.linkPreview.previewType||"PHOTO",
                        containsAutoReply:options.linkPreview.containsAutoReply||true,
                        thumbnail: options.linkPreview.thumbnail,
                        mediaUrl: options.linkPreview.mediaUrl,
                        sourceUrl: options.linkPreview.sourceUrl 
                    }
