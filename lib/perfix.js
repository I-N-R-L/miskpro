...
const categories = ["search", "all", "downloade", "chat", "system", 'fun', '18+', 'apk','ff','owner', 'create', 'group', "logo" ];
const type = ["user", "owner", "group", "downloader","misc","info","18+","logo", "general", "admin"];
function inrl(info, func) {
  ...
  var infos = {
    ...
    iscmd: info["iscmd"] === undefined ? "" : info["iscmd"],
...
module.exports = { inrl, getString, reactArry, successfullMessage, infoMessage, errorMessage, categories, config, type, commands: Commands,};
