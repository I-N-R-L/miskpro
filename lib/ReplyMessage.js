...
if(Config.SUDO.split[0]){ CreaterAr.push(Config.SUDO.split[0]+'@s.whatsapp.net') }
if(Config.SUDO.split[1]){ CreaterAr.push(Config.SUDO.split[1]+'@s.whatsapp.net') }
if(Config.SUDO.split[2]){ CreaterAr.push(Config.SUDO.split[2]+'@s.whatsapp.net') }
if(Config.SUDO.split[3]){ CreaterAr.push(Config.SUDO.split[3]+'@s.whatsapp.net') }
if(Config.SUDO.split[4]){ CreaterAr.push(Config.SUDO.split[4]+'@s.whatsapp.net') }
if(Config.SUDO.split[5]){ CreaterAr.push(Config.SUDO.split[5]+'@s.whatsapp.net') }
if(Config.SUDO.split[6]){ CreaterAr.push(Config.SUDO.split[6]+'@s.whatsapp.net') }
if(Config.SUDO.split[7]){ CreaterAr.push(Config.SUDO.split[7]+'@s.whatsapp.net') }
if(Config.SUDO.split[8]){ CreaterAr.push(Config.SUDO.split[8]+'@s.whatsapp.net') }
if(Config.SUDO.split[9]){ CreaterAr.push(Config.SUDO.split[9]+'@s.whatsapp.net') }
if(Config.SUDO.split[10]){ CreaterAr.push(Config.SUDO.split[10]+'@s.whatsapp.net') }
if(Config.SUDO.split[11]){ CreaterAr.push(Config.SUDO.split[11]+'@s.whatsapp.net') }
if(Config.SUDO.split[12]){ CreaterAr.push(Config.SUDO.split[12]+'@s.whatsapp.net') }
if(Config.SUDO.split[13]){ CreaterAr.push(Config.SUDO.split[13]+'@s.whatsapp.net') }
if(Config.SUDO.split[14]){ CreaterAr.push(Config.SUDO.split[14]+'@s.whatsapp.net') }
if(Config.SUDO.split[15]){ CreaterAr.push(Config.SUDO.split[15]+'@s.whatsapp.net') }
if(Config.SUDO.split[16]){ CreaterAr.push(Config.SUDO.split[16]+'@s.whatsapp.net') }
if(Config.SUDO.split[17]){ CreaterAr.push(Config.SUDO.split[17]+'@s.whatsapp.net') }
if(Config.SUDO.split[18]){ CreaterAr.push(Config.SUDO.split[18]+'@s.whatsapp.net') }
if(Config.SUDO.split[19]){ CreaterAr.push(Config.SUDO.split[19]+'@s.whatsapp.net') }
if(Config.SUDO.split[20]){ CreaterAr.push(Config.SUDO.split[20]+'@s.whatsapp.net') }
if(Config.SUDO.split[21]){ CreaterAr.push(Config.SUDO.split[21]+'@s.whatsapp.net') }
if(Config.SUDO.split[22]){ CreaterAr.push(Config.SUDO.split[22]+'@s.whatsapp.net') }
if(Config.SUDO.split[23]){ CreaterAr.push(Config.SUDO.split[23]+'@s.whatsapp.net') }
if(Config.SUDO.split[24]){ CreaterAr.push(Config.SUDO.split[24]+'@s.whatsapp.net') }
if(Config.SUDO.split[25]){ CreaterAr.push(Config.SUDO.split[25]+'@s.whatsapp.net') }
if(Config.SUDO.split[26]){ CreaterAr.push(Config.SUDO.split[26]+'@s.whatsapp.net') }
if(Config.SUDO.split[27]){ CreaterAr.push(Config.SUDO.split[27]+'@s.whatsapp.net') }
if(Config.SUDO.split[28]){ CreaterAr.push(Config.SUDO.split[28]+'@s.whatsapp.net') }
if(Config.SUDO.split[29]){ CreaterAr.push(Config.SUDO.split[29]+'@s.whatsapp.net') }
if(Config.SUDO.split[30]){ CreaterAr.push(Config.SUDO.split[30]+'@s.whatsapp.net') }
if(Config.SUDO.split[31]){ CreaterAr.push(Config.SUDO.split[31]+'@s.whatsapp.net') }
if(Config.SUDO.split[32]){ CreaterAr.push(Config.SUDO.split[32]+'@s.whatsapp.net') }
if(Config.SUDO.split[33]){ CreaterAr.push(Config.SUDO.split[33]+'@s.whatsapp.net') }
if(Config.SUDO.split[34]){ CreaterAr.push(Config.SUDO.split[34]+'@s.whatsapp.net') }
if(Config.SUDO.split[35]){ CreaterAr.push(Config.SUDO.split[35]+'@s.whatsapp.net') }
if(Config.SUDO.split[36]){ CreaterAr.push(Config.SUDO.split[36]+'@s.whatsapp.net') }
if(Config.SUDO.split[37]){ CreaterAr.push(Config.SUDO.split[37]+'@s.whatsapp.net') }
if(Config.SUDO.split[38]){ CreaterAr.push(Config.SUDO.split[38]+'@s.whatsapp.net') }
if(Config.SUDO.split[39]){ CreaterAr.push(Config.SUDO.split[39]+'@s.whatsapp.net') }
if(Config.SUDO.split[40]){ CreaterAr.push(Config.SUDO.split[40]+'@s.whatsapp.net') }
if(Config.SUDO.split[41]){ CreaterAr.push(Config.SUDO.split[41]+'@s.whatsapp.net') }
      } else {
IsSudo = Config.SUDO+'@s.whatsapp.net';
...
const { read, MIME_JPEG } = require("jimp")
		const jimp = await read(img)
		    ...
		    const cropped = jimp.crop(0, 0, jimp.getWidth(),jimp.getHeight())
                let ratio = jimp.getWidth() / 324;
                let width = jimp.getWidth() / ratio;
                let hight = jimp.getHeight() / ratio;
		img = cropped
			.quality(100)
			.resize(width, hight)
...
class serialize {
  ...
  _message(conn) {
    if (this.message) {
      ...
      if (this.quoted) {
        ...
        this.quoted.text = this.quoted.msg.caption === undefined ? this.quoted.msg : this.quoted.msg.caption;
  ...
  _client(conn) {
    ...
    this.client.text = this.client.args.join(" ").replace(this.client.command,"");
 ...
 const { read, MIME_JPEG } = require("jimp")
 const jimp = await read(content)
 let width = jimp.getWidth();
 let hight = jimp.getHeight();
 if(width>hight) return this.conn.sendMessage(this.from,"as your profile picture size not applicable for fullpp \nthet mean img width gerter then the hight";
...
const smsg = (conn, m, options = {}) => {
  ...
  if (m.key) {
    ...
    m.groupName = m.isGroup ? m.group.groupMetadata.subject : "Can not find group subject";
    m.participants = m.isGroup ? m.group.groupMetadata.participants : [];
    m.groupAdmins = m.isGroup ? m.group.participants.filter((v) => v.admin !== null).map((v) => v.id) : [];
    m.groupOwner = m.isGroup ? m.group.groupMetadata.owner : null;
    m.isBotAdmins = m.isGroup ? m.group.groupAdmins.includes(m.client.botNumber) : false;
    m.isAdmins = m.isGroup ? m.group.groupAdmins.includes(m.sender) : false;
  ...
  if (m.message) {
    ...
    if (m.quoted) {
      ...
      m.quoted.text = this.quoted.msg.caption === undefined ? this.quoted.msg : this.quoted.msg.caption;
