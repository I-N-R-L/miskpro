...
/**
  ...
  async sendAdMsg(id, text, UrL = {}, quoted = {}, options = {}) {
    this.sendMessage(id, { text: ...options, contextInfo:{"externalAdReply": {"title": ` ${Config.BOT_INFO.split(",")[0]}`,"body": `${Config.BOT_INFO.split(",")[1]}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/imagee.jpg`),"sourceUrl": UrL}}}, { quoted: ...options})
        }
  /**
   *
   * @param {*} message
