...
/**
   ...
   * @param {*} options
   */
  async sendAdMsg(id, text, contextInfo, externalAdReply, title, body, previewType, thumbnailUrl, thumbnail, sourceUrl, quoted = {}, options = {}) {
    this.sendMessage(id, { text: ...options, contextInfo:{externalAdReply: {title: ...options, body : ...options, previewType: ...options, thumbnailUrl :...options, thumbnail : fs.readFileSync('./media/imagee.jpg'), sourceUrl :  ...options }}},{ quoted: ...options})
  }
...
async sendImageAsSticker(jid, path, quoted = {}, options = {}) {
        ...
        await this.sendMessage(jid, { sticker: { url: buffer }, ...options }, { quoted, ...options })
        return buffer
    }
/**
     * 
