...
/**
   ...
   * @param {*} options
   */
  async sendAdMsg(id, text, quoted = {}, options = {}) {
    this.sendMessage(id, { text: ...options, contextInfo:{"externalAdReply": {"title": `${Config.BOT_INFO.split(",")[0]}`,"body": `${Config.BOT_INFO.split(",")[0]}`, "previewType": `PHOTO`,"thumbnailUrl": ${Config.ALIVE},"thumbnail": fs.readFileSync('./media/imagee.jpg'),"sourceUrl":${Config.ALIVE} }}},{ quoted: ...options})
  }
