...
const { getRandom, fetchBuffer, getBuffer } = require("./cloud");
  ...
  _message(conn) {
    if (this.message) {
      ...
      if (this.quoted) {
        ...
        this.quoted.text =
          this.quoted.message?.conversation ||
          this.quoted.message?.[this.quoted.type]?.text ||
          this.quoted.message?.[this.quoted.type]?.caption ||
          this.quoted.message?.[this.quoted.type]?.contentText ||
          this.quoted.message?.[this.quoted.type]?.selectedDisplayText ||
          this.quoted.message?.[this.quoted.type]?.title ||
      "";
    ...
    this.client.displayId = this.client.body =
      ...
      this.type === "messageContextInfo"
        ? this.message.buttonsResponseMessage?.selectedButtonId ||
          ...
          this.text
        : "";
//  this.client.body = (this.mtype === 'conversation') ? this.message.conversation : (this.mtype == 'imageMessage') ? this.message.imageMessage.caption : (this.mtype == 'videoMessage') ? this.message.videoMessage.caption : (this.mtype == 'extendedTextMessage') ? this.message.extendedTextMessage.text : (this.mtype == 'buttonsResponseMessage') ? this.message.buttonsResponseMessage.selectedButtonId : (this.mtype == 'listResponseMessage') ? this.message.listResponseMessage.singleSelectReply.selectedRowId : (this.mtype == 'templateButtonReplyMessage') ? this.message.templateButtonReplyMessage.selectedId : (this.mtype === 'messageContextInfo') ? (this.message.buttonsResponseMessage?.selectedButtonId || this.message.listResponseMessage?.singleSelectReply.selectedRowId || this.text) : ''
