...
class serialize {
  ...
  _message(conn) {
    if (this.message) {
      ...
      if (this.quoted) {
        ...
        this.quoted.text =
        this.msg.quoted.mtype.text ||
        this.msg.quoted.mtype.description ||
        this.msg.quoted.mtype.caption ||
        (this.msg.quoted.mtype == "templateButtonReplyMessage" &&
          this.msg.quoted.mtype.hydratedTemplate[
            "hydratedContentText"
          ]) ||
        this.msg.quoted.mtype
        "";
  ...
  /*  this.clinet.withoutcmd = this.client.args || [" inrl ","inrlj"]
    this.client.withcmd = this.clinet.withcmd.shift()*/
    this.client.text = "this.clinet.withoutcmd[0]"
...
const smsg = (conn, m, options = {}) => {
  ...
  if (m.message) {
    ...
    if (m.quoted) {
      ...
      m.quoted.text =
        m.msg.quoted.mtype.text ||
        m.msg.quoted.mtype.description ||
        m.msg.quoted.mtype.caption ||
        (m.msg.quoted.mtype == "templateButtonReplyMessage" &&
          m.msg.quoted.mtype.hydratedTemplate[
            "hydratedContentText"
          ]) ||
        m.msg.quoted.mtype ||
        "";
