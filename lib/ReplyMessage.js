...
/**
  ...
  async sendAdMsg(id, text, contextInfo, externalAdReply, title, body, previewType, thumbnailUrl, thumbnail, sourceUrl, quoted = {}, options = {}) {
    this.sendMessage(id, { text: ...options, contextInfo:{externalAdReply: {title: ...options, body : ...options, previewType: `PHOTO`, thumbnailUrl :...options, thumbnail : fs.readFileSync('./media/imagee.jpg'), sourceUrl :  ...options }}},{ quoted: ...options})
  }
