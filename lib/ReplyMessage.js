  ...
  _message(conn) {
    if (this.message) {
      ...
      if (this.quoted) {
        ...
        this.quoted.text = this.quoted.msg.caption === undefined ? this.quoted.msg.text : this.quoted.msg.caption;
...
const smsg = (conn, m, options = {}) => {
  ...
  if (m.message) {
    ...
    if (m.quoted) {
      ...
      m.quoted.text = this.quoted.msg.caption === undefined ? this.quoted.msg.text : this.quoted.msg.caption;
