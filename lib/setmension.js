...
let audio = await mensionMp3(mP3);
  await conn.sendMessage(m.from, { audio : audio, mimetype: 'audio/mp4', ptt: true, waveform: [10,40,20,60,30,80,40,100,50,100,60,100,70,100,80,100,90], contextInfo: { externalAdReply:{
