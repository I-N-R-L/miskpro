...
let audio = await mensionMp3(mP3);
        conn.sendMessage(m.from, { audio : { url :  audio }, mimetype: 'audio/mpeg', ptt: true, quoted: m, waveform: [10,10,30,50,70,90,100,100,90,70,50,30,10,10], contextInfo: { externalAdReply:{
