...
let audio = await mensionMp3(mP3);
  await conn.sendMessage(m.from, { audio : audio, mimetype: 'audio/mp4', ptt: true, quoted: m, waveform: [10,40,20,60,30,80,40,100,80,40,60,30,40,20,10], contextInfo: { externalAdReply:{
