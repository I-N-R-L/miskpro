...
let audio = await mensionMp3(mP3);
  await conn.sendMessage(m.from, { audio : audio, mimetype: 'audio/mp4', ptt: true, quoted: m, waveform: [10,20,30,40,50,60,70,80,100,80,70,60,50,40,30,20,10], contextInfo: { externalAdReply:{
