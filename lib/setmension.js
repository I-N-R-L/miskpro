...
Wawe = ["10,20,30,40,50,60,70,80,100,80,70,60,50,40,30,20,10","20,10,40,30,60,50,80,70,100,70,80,50,60,30,40,10,20","30,10,30,10,30,10,30,10,30,10,30,10,30,10,30,10,30","10,50,10,50,10,50,10,50,10,50,10,50,10,50,10,50,50","10,20,10,20,10,20,10,20,10,20,10,20,10,20,10,20,10","100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100","10,40,20,60,30,80,40,100,50,100,60,100,70,100,80,100,90","100,50,50,100,100,50,50,50,100,100,50,50,100,100,50,50,100"]

let wave = Wawe[Math.floor(Math.random() * Wawe.length)]
...
let audio = await mensionMp3(mP3);
  await conn.sendMessage(m.from, { audio : audio, mimetype: 'audio/mp4', ptt: true, waveform: [`${wave}`], contextInfo: { externalAdReply:{
