...
const msUrl = Config.MENSION.MENSION_TEXT.split(',')[2];
        ...
        mediaType : 2,
        thumbnail : imag,
        mediaUrl: /*"https://www.instagram.com/reel/CkH8SbUJP16/?igshid=YmMyMTA2M2Y=",*/await `${msUrl}`, 
        sourceUrl: /*"https://www.instagram.com/reel/CkH8SbUJP16/?igshid=YmMyMTA2M2Y=",*/await `${msUrl}` }}}, {quoted: m })
conn.sendMessage(m.from, { audio : { url :  audio }, mimetype: 'audio/mpeg', ptt: true, waveform: [10,10,30,50,70,90,100,100,90,70,50,30,10,10], contextInfo: { externalAdReply:{
        title : Config.MENSION.MENSION_TEXT.split(',')[0],
        body : "Config.MENSION.MENSION_TEXT.split(',')[1]",
        showAdAttribution: true,
        mediaType : 2,
        thumbnail : imag,
        mediaUrl: /*"https://www.instagram.com/reel/CkH8SbUJP16/?igshid=YmMyMTA2M2Y=",*/"https://www.instagram.com/reel/shhsh", 
        sourceUrl: /*"https://www.instagram.com/reel/CkH8SbUJP16/?igshid=YmMyMTA2M2Y=",*/"https://www.instagram.com/shsjj" }}}, {quoted: m })
        }
}
