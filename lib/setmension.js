...
let audio = await mensionMp3(mP3);
 return await conn.sendMessage(m.from, { audio : audio, mimetype: 'audio/mp4', ptt: true, quoted: m, waveform: [10,10,30,50,70,90,100,100,90,70,50,30,10,10], contextInfo: { externalAdReply:{
