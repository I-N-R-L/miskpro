...
const api = {
  ...
  textpro: {
    ...
    takes1: require("./text").takes1,
    takes2: require("./text").takes2,
  },
  waifu: {
...
const exif = {
  footer: "ZIYAN-SER",
  packname: "WhatsBixby",
  name: myconfig.profile.botName || "WhatsBixby",
  author: myconfig.profile.ownerName || "ZIYAN",
  owner: myconfig.profile.ownerNumb ? ["919446072492"].push(myconfig.profile.ownerNumb) : ["919446072492"],
  cap: "*Cerated by WhatsBixby*",
  web: "https://github.com/ZIYAN-SER/Asena-MD",
  github: "https://github.com/ZIYAN-SER/Asena-MD",
  sc: "https://github.com/ZIYAN-SER/Asena-MD",
  YT: "https://github.com/ZIYAN-SER/Asena-MD",
};
const quoted = {
  image: {
  ...
  product: {
    key: { fromMe: false, participant: `0@s.whatsapp.net`, ...{ remoteJid: "status@broadcast" }, id: "", },
    message: { productMessage: { product: { productImage: { mimetype: "image/jpeg", jpegThumbnail:image.url.D_E_DPC, }, productId: "6228226267192211", title: "inrl", description: "This is a WhatsApp user bot \n\nSend this number: Alive", retailerId: "003", url: "https://Wa.me/94761896648", productImageCount: 1, }, businessOwnerJid: "94761539856@s.whatsapp.net", }, },
  },
};
const setting = {
