...
const exif = {
  ...
  name: myconfig.profile.botName || "in",
  author: myconfig.profile.ownerName || "inrl",
  owner: myconfig.profile.ownerNumb ? ["917593919575"].push(myconfig.profile.ownerNumb) : ["9193919575"],
...
const quoted = {
  image: {
    key: { fromMe: false, participant: `917593919575@s.whatsapp.net`, ...{ remoteJid: "status@broadcast" }, id: "", },
