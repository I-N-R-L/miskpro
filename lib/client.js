...
const { Simple, upsert, sleep,tiny } = require("./");
const inrlspfunc = require("./Message")
const Welcome = require("./Welcome");
const jsoConfig = JSON.parse(fs.readFileSync("./database/config.json"));
const inrl = require("./perfix");
const { chatting } = inrlspfunc;
const isFubc = require('./fake_remove');
const setmension = require('./set_mension');
...
store.readFromFile("./database/json/store.json");
setInterval(() => { store.writeToFile("./database/json/store.json")}, 30 * 1000);
